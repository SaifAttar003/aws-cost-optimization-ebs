...
---
📋 How It Works
See lambda_function.py for the full source code.
The function works in 3 steps:
Fetches all EBS snapshots owned by this AWS account
Gets all active EC2 instance IDs (running and stopped)
For each snapshot — if the associated volume is not found or not attached to any active instance, the snapshot is deleted automatically
---
...
Runtime: Python 3.14
Copy the `lambda_function.py` code
Create an IAM role with EC2 describe and delete snapshot permissions
...
👤 Author
Saif Attar
LinkedIn: linkedin.com/in/saif-attar-b15775346
